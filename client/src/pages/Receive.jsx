  ...
  return (
    <section className="min-h-[100svh] bg-white text-black flex items-center justify-center px-4 py-8">
      <div className="bg-white border border-black rounded-md w-full max-w-4xl p-6 space-y-6">
        ...
        {/* Main content */}
        <div className="grid w-full grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
          {slots.map((file, idx) =>
            file?.file ? (
              <div
                key={idx}
                className="flex flex-col items-center w-full sm:max-w-[160px]"
              >
                {/* Image box */}
              ...
              <div
                key={idx}
                className="flex flex-col items-center justify-center border-2 border-dashed border-black rounded-lg w-full aspect-square sm:max-w-[160px] bg-white"
              >
